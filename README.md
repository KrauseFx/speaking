...
> Felix is the creator of fastlane, the number one open source toolset for automating iOS and Android development and deployment tasks. He’s worked at Google, Twitter and other tech companies, and released various in-depth iOS Security and Privacy publications. Currently Felix works as the founder of ContextSDK, a new developer tool to better adapt one’s iOS app into the real-world context the app is used in
